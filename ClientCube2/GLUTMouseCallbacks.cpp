...
void mouseMotion(int x, int y)
{
   ...
   eye_theta = eye_theta + drag_speed * (previous_x - x);  // longitude
   eye_phi   = eye_phi   + drag_speed * (previous_y - y);  // latitude, north pole at 0
...
void rotateAboutX(double *vector, double angle)
{
   ...
   new_vector[1] = cos(angle * PI/180.0) * vector[1] - sin(angle * PI/180.0) * vector[2];
   new_vector[2] = sin(angle * PI/180.0) * vector[1] + cos(angle * PI/180.0) * vector[2];
...
void rotateAboutY(double *vector, double angle) /* not used! */
{
   ...
   new_vector[0] =  cos(angle * PI/180.0) * vector[0] + sin(angle * PI/180.0) * vector[2];
   new_vector[2] = -sin(angle * PI/180.0) * vector[0] + cos(angle * PI/180.0) * vector[2];
...
void rotateAboutZ(double *vector, double angle)
{
   ...
   new_vector[0] = cos(angle * PI/180.0) * vector[0] - sin(angle * PI/180.0) * vector[1];
   new_vector[1] = sin(angle * PI/180.0) * vector[0] + cos(angle * PI/180.0) * vector[1];
