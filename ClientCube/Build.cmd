...
g++.exe -c -Wall %DEBUG% -I../gl -o mainCube.o mainCube.cpp
g++.exe -Wall -o mainCube.exe mainCube.o GLUTCallbacks.o SceneLib.o SceneRenderLib.o SceneRenderOpenGlLib.o -lopengl32 -lglu32 -lglut32
